...
// Load the two files into Spark datasets
        Dataset<Row> df1 = spark.read().csv("D:\\spark\\file1.csv").toDF("col1", "col2");
        Dataset<Row> df2 = spark.read().csv("D:\\spark\\file2.csv").toDF("col1", "col2");
...
// Compare the values in the two files
        Dataset<Row> resultDF = joinedDF.withColumn("equal",
